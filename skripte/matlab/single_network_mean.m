...
conn_dir = [hchs_dir, '/fMRI_resting/conn_mat/aroma_gsr_matrix']; %%% VERSUCH !!
...
% mean association
                              within_asso = [mean_default,mean_dorsal,mean_salven,mean_cont,mean_limb]
                              mean_within_asso = mean(within_asso)
                              mean_within_asso_all(subjind,:) = mean_within_asso; 
                              
% mean sensory
                              within_sensor = [mean_sommot,mean_vis]
                              mean_within_sensor = mean(within_sensor)
                              mean_within_sensor_all(subjind,:) = mean_within_sensor; 
              end
  
                   save([target_dir '/conn_all'],'conn_all');
                   ...
                   save([target_dir '/mean_within_all'],'mean_within_all');
                   save([target_dir '/mean_within_asso_all'],'mean_within_asso_all');
                   save([target_dir '/mean_within_sensor_all'],'mean_within_sensor_all');
                   
                    save([target_dir '/mean_default_sign'],'mean_default_sign_all'); 
                    save([target_dir '/mean_dorsal_sign'],'mean_dorsal_sign_all');
                    save([target_dir '/mean_salven_sign'],'mean_salven_sign_all'); 
                    save([target_dir '/mean_sommot_sign'],'mean_sommot_sign_all'); 
                    save([target_dir '/mean_vis_sign'],'mean_vis_sign_all'); 
                    save([target_dir '/mean_conn_sign'],'mean_conn_sign_all'); 
                   ...
                   save([target_dir '/default_sign'],'default_sign');
                   save([target_dir '/dorsal_sign'],'dorsal_sign');
                   save([target_dir '/salven_sign'],'salven_sign');
      end
