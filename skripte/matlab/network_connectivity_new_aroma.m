      ...
      for ind_thresh = 1:num_thresh;
              thresh  = all_thresh(ind_thresh);
                      ...
                      if absolute_values
                         ...
                         target_dir_with = [hchs_dir, '/fMRI_resting/results_200_7_aroma/mean_aroma_abs_' num2str(thresh)];

                         target_dir_3d =   [hchs_dir, '/fMRI_resting/results_200_7_aroma/mean_aroma_abs_' num2str(thresh) '/Matrix_3d']

                      elseif no_negative 

                         target_dir_with = [hchs_dir, '/fMRI_resting/results_200_7_aroma/mean_aroma_no_neg_' num2str(thresh)];

                         target_dir_3d =   [hchs_dir, '/fMRI_resting/results_200_7_aroma/mean_aroma_no_neg_' num2str(thresh) '/Matrix_3d'] 
               

                      else

                         target_dir_with = [hchs_dir, '/fMRI_resting/results_200_7_aroma/mean_aroma_' num2str(thresh)];

                         target_dir_3d =   [hchs_dir, '/fMRI_resting/results_200_7_aroma/mean_aroma_' num2str(thresh) '/Matrix_3d']
...
%                                      z2 = zscore(Mat)
                                ...
                                %% Global Connectivity
                                  ...
                                  [~, mod] = modularity_und(conn);
                                  modul_global = mod;
                                  modul_global_all(subjind,:) = mod;
                              ...
                              % s=mean(half_default(logical(triu(ones(size(half_default))))))
                               ...
                               %% CONNECTIVITY BETWEEN NETWORKS
                                  ...
                                  if absolute_values
                                     ...
                                     target_dir_bet = [hchs_dir, '/fMRI_resting/results_200_7_aroma/mean_aroma_abs_' num2str(thresh) '/between_net'];

                                  elseif no_negative

                                      target_dir_bet = [hchs_dir, '/fMRI_resting/results_200_7_aroma/mean_aroma_no_neg_' num2str(thresh) '/between_net'];

                                  else

                                     target_dir_bet = [hchs_dir, '/fMRI_resting/results_200_7_aroma/mean_aroma_' num2str(thresh) '/between_net'];
...
% Modularity association
                    modul_sensor = [modul_sommot, modul_vis];
                    modul_sensor = mean(modul_sensor);
                    modul_sensor_all(subjind,:) = modul_sensor;                     

% Modularity association
                    modul_asso = [modul_default, modul_dorsal, modul_salven, modul_sommot, modul_cont,modul_limb];
                    modul_asso = mean(modul_asso);
                    modul_asso_all(subjind,:) = modul_asso;    
              end
                    ...
                    % Saving modularity of networks
                    save([target_dir_bet  '/modul_global'],'modul_global');
                    save([target_dir_bet  '/modul_default'],'modul_default');
                    save([target_dir_bet  '/modul_dorsal'],'modul_dorsal');
                    save([target_dir_bet  '/modul_salven'],'modul_salven');
                    save([target_dir_bet  '/modul_sommot'],'modul_sommot');
                    save([target_dir_bet  '/modul_cont'],'modul_cont');
                    
                    save([target_dir_bet  '/modul_vis'],'modul_vis');
                    save([target_dir_bet  '/modul_limb'],'modul_limb');                    
                    ...
                    % Saving segregation global
                    save([target_dir_bet  '/modul_global'],'modul_global');
                    save([target_dir_bet  '/modul_asso'],'modul_asso');
                    save([target_dir_bet  '/modul_sensor'],'modul_sensor');
