...
main_dir = [hchs_dir, '/fMRI_resting/matrix_200_7_aroma'];
         ...
         for ind_thresh = 1:num_thresh;
              thresh  = all_thresh(ind_thresh);
                      ...
                      if absolute_values
                             ...
                             conn_dir = [hchs_dir, '/fMRI_resting/results_200_7_aroma/mean_aroma_abs_' num2str(thresh)];
                             conn_dir_betw = [hchs_dir, '/fMRI_resting/results_200_7_aroma/mean_aroma_abs_' num2str(thresh) '/between_net'];
                             conn_dir_str =  [hchs_dir, '/MRI_dwi/results_200_7/sift_radius2_0']

                       elseif no_negative   
                             conn_dir = [hchs_dir, '/fMRI_resting/results_200_7_aroma/mean_aroma_no_neg_' num2str(thresh)];
                             conn_dir_betw = [hchs_dir, '/fMRI_resting/results_200_7_aroma/mean_aroma_no_neg_' num2str(thresh) '/between_net'];
                             conn_dir_str =  [hchs_dir, '/MRI_dwi/results_200_7/sift_radius2_0']    

                       else
                             conn_dir = [hchs_dir, '/fMRI_resting/results_200_7_aroma/mean_aroma_' num2str(thresh)];
                             conn_dir_betw = [hchs_dir, '/fMRI_resting/results_200_7_aroma/mean_aroma_' num2str(thresh) '/between_net'];
                             conn_dir_str =  [hchs_dir, '/MRI_dwi/results_200_7/sift_radius2_0' ]
                       end  
%                                            
% 
         ...
         %% Anticorrelation single Network Values functional            
                      cd(conn_dir_str)
...
all_val = table( id,age,sex, TMTA, TMTB ... 
                 ,mean_conn_all_str, mean_default_all_str,mean_dorsal_all_str,mean_salven_all_str, mean_cont_all_str , mean_limb_all_str, mean_sommot_all_str, mean_vis_all_str ...
                 ,mean_default_sign_all_str,mean_dorsal_sign_all_str,mean_salven_sign_all_str,mean_cont_sign_all_str, mean_limb_sign_all_str, mean_sommot_sign_all_str, mean_vis_sign_all_str ...
                 ,mean_default_sign_all_str_increase,mean_salven_sign_all_str_increase,mean_cont_sign_all_str_increase, mean_limb_sign_all_str_increase, mean_sommot_sign_all_str_increase, mean_vis_sign_all_str_increase ...
                 ,seg_global_all,seg_asso_all, seg_sensor_all,seg_default_all,seg_dorsal_all,seg_salven_all,seg_cont_all,seg_limb_all, seg_sommot_all, seg_vis_all ...
                 .modul_global, modul_asso, modul_sensor, modul_default, modul_dorsal, modul_salven, modul_cont, modul_limb, modul_sommot, modul_vis ...
                 ,mean_default_all,mean_dorsal_all,mean_salven_all,mean_cont_all, mean_limb_all, mean_sommon_all, mean_vis_all ...
                 ,default_betw_all,dorsal_betw_all,salven_betw_all,cont_betw_all,limb_betw_all, sommot_betw_all, vis_betw_all ...
 ...
 %% Change to Table
            ...
            if absolute_values
                writetable(all_val,[target_dir '/HCHS_new_' num2str(thresh) '_aroma_abs.csv'])

            elseif no_negative    

                writetable(all_val,[target_dir '/HCHS_new_' num2str(thresh) '_aroma_no_neg.csv']) 
          
            else

                writetable(all_val,[target_dir '/HCHS_new_' num2str(thresh) '_aroma.csv'])
