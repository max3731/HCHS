         ...
         for ind_thresh = 1:num_thresh;
              thresh  = all_thresh(ind_thresh);
                      ...
                      if absolute_values
                         ...
                         conn_dir = [hchs_dir, '/fMRI_resting/results_200_7_aroma/mean_aroma_abs_anti_' num2str(thresh)];

                         conn_dir_betw =   [hchs_dir, '/fMRI_resting/results_200_7_aroma/mean_aroma_abs_anti_' num2str(thresh) '/between_net']
                      ...
                      elseif anticorrelation 
                         ...
                         conn_dir = [hchs_dir, '/fMRI_resting/results_200_7_aroma/mean_aroma_anti_' num2str(thresh)];

                         conn_dir_betw =   [hchs_dir, '/fMRI_resting/results_200_7_aroma/mean_aroma_anti_' num2str(thresh) '/between_net'] 
...
all_val = table( id,age,sex, TMTA, TMTB ... 
                 ...
                 ,anti_mean_default_all,anti_mean_dorsal_all,anti_mean_salven_all,anti_mean_cont_all, anti_mean_limb_all, anti_mean_sommon_all, anti_mean_vis_all ...
                 ,anti_default_betw_all,anti_dorsal_betw_all,anti_salven_betw_all,anti_cont_betw_all,anti_limb_betw_all, anti_sommot_betw_all, anti_vis_betw_all ...
                 ,anti_mean_conn_all, anti_mean_global_within_all, anti_mean_global_between_all)
 %% Change to Table
            ...
            if absolute_values
                writetable(all_val,[target_dir '/HCHS_new_' num2str(thresh) '_aroma_abs_anti.csv'])

            elseif anticorrelation    

                writetable(all_val,[target_dir '/HCHS_new_' num2str(thresh) '_aroma_anti.csv']) 
