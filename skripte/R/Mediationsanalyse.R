...
#HCHS = read.csv("C:/Users/mschu/Documents/Documents/CSI/R-Skripte/hw1_data.csv")
...
plotNormalHistogram(HCHS$hypertension)

# Smoking into dummy variable
...
tempData <- mice(HCHS,m=5,maxit=1,meth= "logreg",seed=500) # hypertension
summary(tempData)
